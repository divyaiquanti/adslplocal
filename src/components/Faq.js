            ...
            <section className="tearms py-5">
                {
                    ...
                    <div className="container">
                        ...
                        <p dangerouslySetInnerHTML={{__html: this.props.terms.description }} />
                    </div>
                    :null
                }
            </section>
                        ...
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"> <span aria-hidden="true"> <LazyLoadImage src="assets/images/popup-close.svg" alt="" effect="blur" /> </span> </span>
                                </button>
                            </div>

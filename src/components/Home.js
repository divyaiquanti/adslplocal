...
class Home extends Component {
    ...
    render() {
        return (
            ...
            <header className="site-header" role="banner">
                <div id="navigation" className="nav">
                    ...
                    <a href={this.props.header.logo_link} className="nav__logo" title="Comenity">
                        <LazyLoadImage  effect="blur" className="nav__logo-image" src={this.props.header.logo} alt={this.props.header.logo_alt} />
                    </a>
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-5 text-center">
                                    <div className="image">
                                    {
                                        this.props.maindata.card_image !== "" ?
            ...
            {
            this.props.divdata.length !== 0 && this.state.isapplyvisible === 1 ?
            ...
            {
                this.props.mainbenefits.length !== 0 ?
                <div className="container">
